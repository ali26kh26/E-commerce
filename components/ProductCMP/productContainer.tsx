...
function productContainer(): JSX.Element {
  ...
  return (
    <div onMouseOver={addClass} onMouseLeave={removeClass} className="w-fit flex flex-col items-center bg-slate-100">
      <div className="border-2 border-solid bg-white relative overflow-hidden">

        {/* big screen */}
        <div ref={customButton} className={style.customButtom}>
          <CustomButton Icon={Heart} className={"bg-white p-2.5 rounded-full"}/>
